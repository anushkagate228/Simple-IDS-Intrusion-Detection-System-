...
- Capture live packets on network interface
- Match payload against signature rules(string/regex)
- Alert on:port scans, SQLi strings, shellcode patterns
- Add custom rules from a config file
- Log all alerts with timestamp, src/dst, matched rule 
